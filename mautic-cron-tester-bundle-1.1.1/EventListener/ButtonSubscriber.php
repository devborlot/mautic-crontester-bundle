...
namespace MauticPlugin\MauticCronTesterBundle\EventListener;
...
use MauticPlugin\MauticCronTesterBundle\Integration\CronTesterIntegration;
...
class ButtonSubscriber implements EventSubscriberInterface
{
     ...
     */
    public function __construct(IntegrationHelper $integrationHelper, TranslatorInterface $translator, Router $router)
    {
    ...
    {
        /** @var CronTesterIntegration $myIntegration */
        $eCronIntegration = $this->integrationHelper->getIntegrationObject('CronTester');
